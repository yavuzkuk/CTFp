  ...
  <div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      ...
      <ul class="nav">
          ...
          <div class="profile-desc">
            <div class="profile-pic">
              ...
              <div class="profile-name">
                <h5 class="mb-0 font-weight-normal"><?php echo $userInfo["u_username"] ?></h5>
              </div>
            </div>
        ...
        <li class="nav-item menu-items">
          <a class="nav-link" data-bs-toggle="collapse" href="#soru" aria-expanded="false" aria-controls="ui-basic">
            <span class="menu-icon">
              <i class="mdi mdi-laptop"></i>
            </span>
            <span class="menu-title">Soru işlemleri</span>
            <i class="menu-arrow"></i>
          </a>
          <div class="collapse" id="soru">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="pages/category.php">Kategori ekleme</a></li>
              <li class="nav-item"> <a class="nav-link" href="pages/question.php">Soru ekleme</a></li>
            </ul>
          </div>
        </li>
        <li class="nav-item menu-items">
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item dropdown d-none d-lg-block">
              <a class="nav-link btn btn-success create-new-button" href="pages/question.php">+ Soru ekle</a>
            </li>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link" id="profileDropdown" href="#" data-bs-toggle="dropdown">
                <div class="navbar-profile">
                  <p class="mb-0 d-none d-sm-block navbar-profile-name"><?php echo $userInfo["u_username"] ?></p>
              ...
              <div class="dropdown-menu dropdown-menu-end navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item preview-item" href="pages/settings.php">
                  <div class="preview-thumbnail">
                    <div class="preview-icon bg-dark rounded-circle">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item preview-item" href="partial/perm/logout.php">
                  <div class="preview-thumbnail">
                    <div class="preview-icon bg-dark rounded-circle">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <?php $number = count($numInfo[0]);
            $title = 'Kullanıcı sayısı';
            $icon = "mdi-account";
            include "partial/numberBox.php" ?>
            <?php $number = count($numInfo[2]);
            $title = 'Kategori sayısı';
            $icon = "mdi-format-list-bulleted-type";
            include "partial/numberBox.php" ?>
            <?php $number = count($numInfo[1]);
            $title = 'Soru sayısı';
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-row justify-content-between">
                    <h4 class="card-title mb-1">Son Aktiviteler</h4>
                    <p class="text-muted mb-1">Your data status</p>
                  </div>
                  <div class="row">
                    <div class="col-12">
                      <div class="preview-list">
                        <?php foreach ($top5s as $top5): ?>
                          <div class="preview-item border-bottom">
                            <div class="preview-thumbnail">
                              <div class="preview-icon bg-<?php $color = ["primary", "danger", "info", "success", "warning"];
                                                          echo $color[random_int(0, count($color) - 1)] ?>">
                                <i class="mdi mdi-account"></i>
                              </div>
                            </div>
                            <div class="preview-item-content d-sm-flex flex-grow">
                              <div class="flex-grow">
                                <h6 class="preview-subject"><?php echo $top5["u_username"] ?></h6>
                                <p class="text-muted mb-0"><?php echo $top5["q_title"] ?></p>
                              </div>
                              <div class="mr-auto text-sm-right pt-2 pt-sm-0">
                                <p class="text-muted"><?php echo $top5["s_date"] ?></p>
                                <p class="text-muted mb-0"><?php echo $top5["c_name"] ?></p>
                              </div>
                            </div>
                          </div>
                        <?php endforeach ?>
